...
public class PetrolsPartsScenes {
    ...
    public static void coaxialGearShaftless(SceneBuilder builder, SceneBuildingUtil util) {
    ...
    public static void coaxialGearThrough(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
        ...
        scene.idle(20);
        scene.overlay().showControls(util.vector().blockSurface(coaxialGear1, Direction.NORTH), Pointing.RIGHT, 60).withItem(PetrolsPartsBlocks.COAXIAL_GEAR.asStack());
        scene.idle(5);
        ...
        scene.idle(20);
        scene.overlay().showControls(util.vector().blockSurface(coaxialGear2, Direction.NORTH), Pointing.RIGHT, 60).withItem(AllBlocks.SHAFT.asStack());
        scene.idle(5);
    ...
    public static void colossalCogwheel(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
        ...
        scene.idle(40);
        scene.effects().rotationDirectionIndicator(controller);
        ...
        scene.idle(40);
        scene.effects().rotationDirectionIndicator(controller.above());
    ...
    public static void doubleCardanShaft(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
        ...
        scene.overlay().showText(100)
            ...
            .attachKeyFrame();
        scene.idle(20);
        scene.overlay().showControls(util.vector().blockSurface(dcs, Direction.NORTH), Pointing.RIGHT, 20).withItem(AllItems.WRENCH.asStack());
        scene.idle(5);
    ...
    public static void hydraulicTransmission(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
    ...
    public static void planetaryGearset(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
